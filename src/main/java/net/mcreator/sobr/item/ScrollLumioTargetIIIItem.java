...
import net.mcreator.sobr.procedures.ScrollUseLumioTargetProcedure;
...
public class ScrollLumioTargetIIIItem extends SobrModElements.ModElement {
	@ObjectHolder("sobr:scroll_lumio_target_iii")
	public static final Item block = null;
	public ScrollLumioTargetIIIItem(SobrModElements instance) {
		super(instance, 25);
	}
	...
	public void initElements() {
		elements.items.add(() -> new ItemToolCustom() {
			...
			public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
				...
				list.add(new StringTextComponent("\u00A73Adept"));
			...
			public ActionResult<ItemStack> onItemRightClick(World world, PlayerEntity entity, Hand hand) {
				...
				double z = entity.posZ;
				{
					...
					ScrollUseLumioTargetProcedure.executeProcedure($_dependencies);
				}
				return retval;
			}
		}.setRegistryName("scroll_lumio_target_iii"));
	}
