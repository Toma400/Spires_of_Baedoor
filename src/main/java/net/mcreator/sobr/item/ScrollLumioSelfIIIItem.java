...
import net.mcreator.sobr.procedures.ScrollUseLumioSelfPreProcedure;
...
public class ScrollLumioSelfIIIItem extends SobrModElements.ModElement {
	@ObjectHolder("sobr:scroll_lumio_self_iii")
	public static final Item block = null;
	public ScrollLumioSelfIIIItem(SobrModElements instance) {
		super(instance, 20);
	}
		...
		elements.items.add(() -> new ItemToolCustom() {
			...
			public ActionResult<ItemStack> onItemRightClick(World world, PlayerEntity entity, Hand hand) {
				...
				double z = entity.getPosZ();
				{
					...
					ScrollUseLumioSelfPreProcedure.executeProcedure($_dependencies);
				}
				return retval;
			}
		}.setRegistryName("scroll_lumio_self_iii"));
	}
