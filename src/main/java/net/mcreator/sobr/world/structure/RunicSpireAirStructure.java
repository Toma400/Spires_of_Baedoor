...
public class RunicSpireAirStructure {
	...
	private static class FeatureRegisterHandler {
		...
		public static void registerFeature(RegistryEvent.Register<Feature<?>> event) {
					...
					if ((random.nextInt(1000000) + 1) <= 0) {
						...
						for (int a = 0; a < count; a++) {
							...
							Template template = world.getWorld().getStructureTemplateManager()
									.getTemplateDefaulted(new ResourceLocation("sobr", "runic_spire_ice"));
							if (template == null)
								return false;
			...
			event.getRegistry().register(feature.setRegistryName("runic_spire_air"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("sobr:runic_spire_air"), configuredFeature);
		}
	}
	@SubscribeEvent
