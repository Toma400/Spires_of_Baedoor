...
package net.mcreator.sobr.world.structure;
...
public class RuneSpireEmptyTestStructure {
	...
	private static class FeatureRegisterHandler {
		...
		public static void registerFeature(RegistryEvent.Register<Feature<?>> event) {
					...
					if ((random.nextInt(1000000) + 1) <= 0) {
						...
						for (int a = 0; a < count; a++) {
							...
							Template template = world.getWorld().getStructureTemplateManager()
									.getTemplateDefaulted(new ResourceLocation("sobr", "rune_spire_empty"));
							if (template == null)
								return false;
			...
			event.getRegistry().register(feature.setRegistryName("rune_spire_empty_test"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("sobr:rune_spire_empty_test"), configuredFeature);
		}
	}
	@SubscribeEvent
